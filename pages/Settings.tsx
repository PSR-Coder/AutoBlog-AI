    ...
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-slate-500">Manage API keys for AI providers and Translation services.</p>
        </div>
        <button
          onClick={handleSave}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200">
          ...
          <div className="space-y-4">
            <div>
              ...
              />
              <p className="text-xs text-slate-500 mt-1">Required for Gemini 2.5 Flash Rewrites.</p>
            </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-slate-200 h-fit">
          <div className="flex items-center space-x-3 mb-6">
            ...
            <h2 className="text-lg font-semibold text-slate-900">Translation Services</h2>
          </div>

          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-slate-700 mb-1">Google Cloud Translate API Key</label>
              <input
                type="password"
              ...
              />
              <p className="text-xs text-slate-500 mt-1">Required for 'Translator Spin' mode (En -&gt; Te -&gt; En).</p>
            </div>
          </div>
        </div>
      </div>
